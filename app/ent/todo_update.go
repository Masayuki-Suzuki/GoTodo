...
func (tu *TodoUpdate) SetDueDate(s string) *TodoUpdate {
	tu.mutation.SetDueDate(s)
	return tu
}

// SetCompletedAt sets the "completed_at" field.
func (tu *TodoUpdate) SetCompletedAt(s string) *TodoUpdate {
	tu.mutation.SetCompletedAt(s)
	return tu
}

// SetCreatedAt sets the "created_at" field.
func (tu *TodoUpdate) SetCreatedAt(s string) *TodoUpdate {
	tu.mutation.SetCreatedAt(s)
	return tu
}
...
func (tu *TodoUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.DueDate(); ok {
		_spec.SetField(todo.FieldDueDate, field.TypeString, value)
	}
	if value, ok := tu.mutation.CompletedAt(); ok {
		_spec.SetField(todo.FieldCompletedAt, field.TypeString, value)
	}
...
// SetDueDate sets the "due_date" field.
func (tuo *TodoUpdateOne) SetDueDate(s string) *TodoUpdateOne {
	tuo.mutation.SetDueDate(s)
	return tuo
}

// SetCompletedAt sets the "completed_at" field.
func (tuo *TodoUpdateOne) SetCompletedAt(s string) *TodoUpdateOne {
	tuo.mutation.SetCompletedAt(s)
	return tuo
}

// SetCreatedAt sets the "created_at" field.
func (tuo *TodoUpdateOne) SetCreatedAt(s string) *TodoUpdateOne {
	tuo.mutation.SetCreatedAt(s)
	return tuo
}
