...
func (*Todo) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case todo.FieldTitle, todo.FieldDescription, todo.FieldStatus, todo.FieldDueDate, todo.FieldCompletedAt, todo.FieldCreatedAt:
	...
	for i := range columns {
		...
		case todo.FieldDueDate:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				t.DueDate = value.String
			}
		case todo.FieldCompletedAt:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field completed_at", values[i])
			} else if value.Valid {
				t.CompletedAt = value.String
			}
...
func (t *Todo) String() string {
	...
	builder.WriteString(t.DueDate)
	builder.WriteString(", ")
	builder.WriteString("completed_at=")
	builder.WriteString(t.CompletedAt)
	builder.WriteString(", ")
