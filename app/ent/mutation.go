...
func (m *TodoMutation) SetDueDate(s string) {
	m.due_date = &s
}

// DueDate returns the value of the "due_date" field in the mutation.
func (m *TodoMutation) DueDate() (r string, exists bool) {
	v := m.due_date
	if v == nil {
		return
	}
...
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldDueDate(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TodoMutation) SetCompletedAt(s string) {
	m.completed_at = &s
}

// CompletedAt returns the value of the "completed_at" field in the mutation.
func (m *TodoMutation) CompletedAt() (r string, exists bool) {
	v := m.completed_at
	if v == nil {
		return
	}
...
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldCompletedAt(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
