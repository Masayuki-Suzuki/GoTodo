...
func (tc *TodoCreate) SetDueDate(s string) *TodoCreate {
	tc.mutation.SetDueDate(s)
	return tc
}

// SetCompletedAt sets the "completed_at" field.
func (tc *TodoCreate) SetCompletedAt(s string) *TodoCreate {
	tc.mutation.SetCompletedAt(s)
	return tc
}
